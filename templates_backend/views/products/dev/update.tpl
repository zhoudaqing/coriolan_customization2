                        ...
                        <div class="controls">
                            ...
                            {if $showUpdateLinkedVariantsButton}
                                <span id="update_variant_linked_price">
                                    ...
                                    <a class="btn btn-primary hand cm-dialog-opener cm-dialog-auto-size cm-ajax" href="{"products.show_all_linked_variants&product_id=`$id`"|fn_url}" data-ca-target-id="option_links_to_products_" name="links_product" data-ca-dialog-title="Legaturile cu acest produs" data-original-title="products" title="">update linked variants</a>&nbsp;
                                </span>
                            {/if}
                        </div>
                    </div>
