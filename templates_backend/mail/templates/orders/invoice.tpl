...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="main-table invoice_test" style="height: 100%; background-color: #f4f6f8; font-size: 12px; font-family: Arial;">
<tr>
    ...
    <tr>
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            {hook name="orders:items_list_row"}
                {if !$oi.extra.parent}
                    <span class="invoice_test" style="display:none">{$order_info.products|var_dump}</span>
                <tr>
