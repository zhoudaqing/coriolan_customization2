    ...
    $.extend({
        ...
        modalAditionalEvent: function(aditionalEvent, aditionalEventParams){
            if(aditionalEvent=='add_carousel'){
                var owl = $("#"+aditionalEventParams.target_id);
                var number_of_elements = 3;
                owl.owlCarousel({
                    items : number_of_elements, //10 items above 1000px browser width
                ...
                if(aditionalEventParams.nr_of_elements > number_of_elements){
                    $('.'+aditionalEventParams.element_to_shift_up).css('padding-bottom','36px');
                   
                    var heightStyle = "width: auto !important;";
                    if ($('.owl-wrapper').attr('style')) {
                        $('.owl-wrapper').attr('style', heightStyle + $('.owl-wrapper').attr('style').replace(/^height: [-,!,0-9,a-z, A-Z, ]*;/,''));
                    }else {
                        $('.owl-wrapper').attr('style', heightStyle);
                    }
                    if ($('.owl-item').attr('style')) {
                        $('.owl-item').attr('style', heightStyle + $('.owl-item').attr('style').replace(/^height: [-,!,0-9,a-z, A-Z, ]*;/,''));
                    }else {
                        $('.owl-wrapper').attr('style', heightStyle);
                    }
                    $('.owl-wrapper').css('width','auto !important');
                    $('.owl-item').css('margin','0 5px').css("width",'auto !important');
...
//                    }
    ...
    */
    ...
    function ls_filter_by_color(selected_value){
        if(selected_value!=""){
            $('div.ty-column4').hide();
