    ...
    {foreach from=$filter.selected_ranges name="selected_ranges" item="selected_range"}
        ...
        <li class="ty-product-filters__group"> 
            {strip}
                ...
                <a href="{$href}" class="ty-product-filters__item checked cm-history" data-ca-scroll=".cm-pagination-container" data-ca-target-id="{$ajax_div_ids}" rel="nofollow"><span class="ty-filter-icon"><i class="ty-icon-ok ty-filter-icon__check"></i><i class="ty-icon-cancel ty-filter-icon__delete"></i></span>{$filter.prefix}{$selected_range.range_name|fn_text_placeholders}{$filter.suffix}</a>
