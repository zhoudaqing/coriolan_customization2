                    ...
                    <div class="ty-footer-form-block ls_conecteaza_div_form">
                        <form action="{""|fn_url}" method="post" name="subscribe_form" class="testsubscribe">
                            ...
                            <div class="ty-footer-form-block__form ty-control-group ty-input-append">
                                ...
                                <button title="Mergeti" class="ty-btn-go abonare_buton" ><a href='{""|fn_url}subscribe'>ABONEAZA-TE</a></button>
                            </div>
                        </form>
                    </div>
                {/if}
                ...
                <div class="ty-footer-form-block ls_conecteaza_div_form">
                    <form action="{""|fn_url}" method="post" name="subscribe_form" class="testsubscribe">
                        ...
                        <div class="ty-footer-form-block__form ty-control-group ty-input-append">
                            ...
                            <input type="text" name="subscribe_email" id="subscr_email{$block.block_id}" size="20" value="{__("enter_email")}" class="cm-hint ty-input-text ls_submit_form" />
                            {*include file="buttons/go2.tpl" but_name="newsletters.add_subscriber" alt=__("go")*}
                            <button title="Mergeti" class="ty-btn-go abonare_buton" ><a href='{""|fn_url}subscribe'>SUBSCRIBE</a></button>
                        </div>
                    </form>
                </div>
            {/if}
