...
{* Chat *}
    		{literal}
				...
				$.src='//cdn.zopim.com/?N6m1TZ5Vu8PPo8Ed3HHKF4EkxhxKBHtF';z.t=+new Date;$.
...
{literal}
       ...
       //  $('.footer_window').children('.ty-dropdown-box__content').css('left',footerDropdownZone);
...
<!--script type="text/javascript">
    	$(document).ready(function()
		{
	/*		$('#ls_slider_cart').tinycarousel({ //initialize carousel and its options
                            axis   : "y", 
                            infinite : true,
                            animationTime : 500
                        });
                        var ls_cart_carousel = $('#ls_slider_cart').data("plugin_tinycarousel"); */
                        
          //      $('#product_features_carusel').tinycarousel();
            
                    //    ls_cart_carousel={};
                  //  Plugin={};
          /*        $('#sw_dropdown_285').on('click', function() {
                          $('#ls_slider_cart').tinycarousel({ //initialize carousel and its options
                            axis   : "y", 
                            infinite : false,
                            animationTime : 500
                      ...
                      var ls_cart_carousel = $('#ls_slider_cart').data("plugin_tinycarousel");
                      ls_cart_carousel.update();
                      console.log('dropdown clicked3');
                  }); */
            //update the carousel on ajax call
          $('body').on('click','div.cm-cart-item-delete',function(){
              //delete the carousel object
           /*    var ls_cart_carousel = $('#ls_slider_cart').data("plugin_tinycarousel");
                   ls_cart_carousel={}; */
                setTimeout(function() {
                   ls_cart_carousel.update();
                //    $.Plugin.setEvents();
                   ls_cart_carousel.ls_setEvents();
                }, 1200); 
        /*      $('#ls_slider_cart').tinycarousel({ //initialize carousel and its options
                            axis   : "y", 
                            infinite : false,
