...
{if $auth.user_id}
    <div class='botmenu_wrapper ls_menu_resize wide_carousel'>
        <div class="ls_upper_preferate">
            ...
            <div class="ls_total_title"><a href='http://coriolan.leadsoft.eu/index.php?dispatch=wishlist.view'>VEZI TOT IN PAGINA DE BIJUTERII FAVORITE </a></div>
...
{else}
    ...
    <div class='botmenu_wrapper ls_menu_resize  wide_carousel'>
        <div class='ls_upper_myaccount'>
            ...
            <div class='ls_bijuterii_favorite'><a href='http://coriolan.leadsoft.eu/index.php?dispatch=wishlist.view'>VEZI TOT IN PAGINA DE BIJUTERII FAVORITE</a></div>
            <div class='ls_close_window'><a href='#'> {__("close")}</a></div>
        </div>
