  ...
  <div class="ls_search_modal_dialog modal-dialog">
    <div class="ls_search_modal_content modal-content">
      <div class="ls_search_modal_header modal-header">
          <div class="ls_close_modal ls_close_window" data-dismiss="modal"><a href="#">{__("close")}</a></div>
      </div>
      <div class="ls_search_body modal-body">
        <div class="ty-search-block ls_search_block modal_block">
            <form method="get" name="search_form" action="{""|fn_url}" class="cm-processed-form ls_search_modal_form modal_form" autocomplete="off">
                ...
                <input type="text" class="ty-search-block__input ls_search_input" id="search_input" value="" name="q" autofocus placeholder="{__("search_products")}" onkeyup="ls_global_vars.counter++;ls_search_autocomplete();"><button type="submit" class="ty-search-magnifier" title="Cautati"><i class="ty-icon-search"></i></button>
