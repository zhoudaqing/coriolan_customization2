{*<div class="ty-sort-container testsortcontainer">
...
<!--div class="ty-sort-dropdown">
    <p>test1</p>
    {*$smarty.capture.ls_filtre_dropdown_class nofilter*}
    {*include file="blocks/product_filters/original.tpl" items=$test_var*}
</div-->
{*added filters*}
