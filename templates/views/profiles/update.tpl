...
<span style="display: none" class="ls_test_profile_fields">{$profile_fields|var_dump}</span>
{if $runtime.mode == "add" && $settings.General.quick_registration == "Y"}
    <div class="ty-account">
    
        <form name="profiles_register_form" action="{""|fn_url}" method="post">
            {include file="views/profiles/components/profile_fields.tpl" section="C" nothing_extra="Y" register=true}
            {include file="views/profiles/components/profiles_account.tpl" nothing_extra="Y" location="checkout" register=true section="C"}
