...
$config['db_name'] = 'coriolan';
$config['db_user'] = 'coriolan';
$config['db_password'] = 'ls_coriolan';
...
$config['http_host'] = 'coriolan.leadsoft.eu';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'coriolan.leadsoft.eu';
$config['https_path'] = '';
...
$config['tweaks'] = array (
    ...
    'allow_php_in_templates' => true //self-explanatory
);

// Key for sensitive data encryption
$config['crypt_key'] = 'HVUTryNBcg';
