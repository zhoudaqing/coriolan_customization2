...
function fn_promotion_apply($zone, &$data, &$auth = NULL, &$cart_products = NULL)
{
    ...
    //var_dump($applied_promotions);echo"<br/>_____<br/>";
...
{
    //var_dump($promotion);echo"<br/>_____<br/>";
    ...
    if($promotion['use_color'] && !$data['promotion_use_color'])
        $data['promotion_use_color'] = $promotion['use_color'];
